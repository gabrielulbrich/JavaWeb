...
@WebServlet("/editar-veiculo")
@ManagedBean
@ViewScoped
public class VeiculoEditarController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("views/editar_veiculo.xhtml").forward(request, response);
    }
